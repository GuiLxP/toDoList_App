...
export default function Home({ navigation }) {
  ...
  function showDescriptionTask(description, category) {
    Alert.alert(category, description);
  }
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.header}>
        ...
        <Image
          source={{
            uri: "https://pps.whatsapp.net/v/t61.24694-24/296237395_799475051406658_8345571438606669084_n.jpg?ccb=11-4&oh=01_AVz3hcJ9UgKzPGeg2ZD4wXjBtqaoNB4kI7DymLYcJn_YIg&oe=631DF42A",
          }}
          style={styles.thumb}
        />
      </View>
      ...
      <ScrollView>
        {tasks.map((task) => (
          <View
            style={{
              ...styles.cardTask,
              backgroundColor: task.status === true ? "green" : "tomato",
            }}
            key={task.id}
          >
            <TouchableOpacity
              ...
              onPress={() =>
                showDescriptionTask(task.description, task.category)
              }
            >
              ...
              <Text numberOfLines={1} ellipsizeMode="tail">
                {format(parseISO(task.date), "dd 'de' MMMM 'de' yyyy", {
                  locale: ptBR,
                })}
              </Text>
            </TouchableOpacity>
